...
const CODE_EXAMPLES: CodeExample[] = [
  {
    ...
    lines: [
      ...
      { text: '', color: '' },
      { text: '@app.get("/vision")', color: 'text-emerald-400' },
      { text: 'async def build():', color: 'text-white' },
      { text: '    return {', color: 'text-white' },
      { text: '        "idea": "tu vision",', color: 'text-amber-300' },
      { text: '        "code": "nuestro codigo",', color: 'text-amber-300' },
  ...
  },
  {
    ...
    lines: [
      ...
      { text: 'WHERE anio = 2026', color: 'text-amber-300' },
